...
ERR_NO_CONNECTION="4"                   # Missing Internet connection needed to install packages
ERR_CREATE_USER="5"                     # Can't create the user

# ZMBACKUP INSTALLATION PATH
MYDIR=`dirname $0`                       # The directory where the install script is
ZMBKP_SRC="/usr/local/bin"               # The main script location
...
OSE_INSTALL_HOSTNAME=`hostname --fqdn`                                                                                                         # Zimbra host's FQDN
